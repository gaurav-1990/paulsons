...
$query1="select * from tbl_story_img where id=?";
...
if(isset($update))
{
	...
	$query="update tbl_story_img set img=? where id=?";
...
<body>
	<u><h3>UPDATE OUR STORY BANNER</h3></u><br>
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group col-md-7">
			<label>UPDATE OUR STORY BANNER IMAGE (1366 X 400):</label>
			<div class="abc">
				<div class="left">
